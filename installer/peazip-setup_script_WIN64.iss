...
LicenseFile=C:\input\peazip-plain-5.2.0.WIN64\copying.txt
InfoBeforeFile=C:\input\peazip-plain-5.2.0.WIN64\readme_Win64.txt
OutputDir=C:\output\
OutputBaseFilename=peazip-plain-5.2.0.WIN64
...
[Files]
Source: "C:\input\peazip-plain-5.2.0.WIN64\peazip.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WIN64\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\input\peazip-plain-5.2.0.WIN64\SendTo.7z"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WIN64\copying.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WIN64\readme_Win64.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WIN64\peazip_help.pdf"; DestDir: "{app}"; Flags: ignoreversion
