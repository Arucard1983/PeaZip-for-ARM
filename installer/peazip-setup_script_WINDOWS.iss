...
LicenseFile=C:\input\peazip-plain-5.2.0.WINDOWS\copying.txt
InfoBeforeFile=C:\input\peazip-plain-5.2.0.WINDOWS\readme_Win32.txt
OutputDir=C:\output\
OutputBaseFilename=peazip-plain-5.2.0.WINDOWS
...
[Files]
Source: "C:\input\peazip-plain-5.2.0.WINDOWS\peazip.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WINDOWS\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\input\peazip-plain-5.2.0.WINDOWS\SendTo.7z"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WINDOWS\copying.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WINDOWS\readme_Win32.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-plain-5.2.0.WINDOWS\peazip_help.pdf"; DestDir: "{app}"; Flags: ignoreversion
